import { mountSmedEvidenceWorkspace } from './smedEvidenceWorkspace'
...
/** Keep the solution-specific renderer separate from the reusable motion. */
export function mountSmedSolutions(): () => void {
  return mountSmedEvidenceWorkspace('smed-solutions', groups)
}
